...
import leftimg from "../assets/leftSideimg.png"
    ...
    return (
        <>
            ...
            >
                ...
                <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden h-full" style={{ backgroundColor: '#f5f3f0' }}>
                    <img
                        src={leftimg}
                ...
                {/* ── RIGHT: Form Panel ── */}
                <div
                    className="w-full lg:w-1/2 flex items-center justify-center h-full overflow-y-auto px-8 sm:px-14 lg:px-20 py-16 overflow-y-auto"
